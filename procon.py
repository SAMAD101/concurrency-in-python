...
class Pipeline:
    ...
    def set_message(self, message, name):
        logging.debug("%s: [DEBUG] about to acquire setlock", name)
        self.producer_lock.acquire()
        logging.debug("%s: [DEBUG] have setlock", name)
        self.message = message
        logging.debug("%s: [DEBUG] about to release getlock", name)
        self.consumer_lock.release()
        logging.debug("%s: [DEBUG] getlock released", name)
